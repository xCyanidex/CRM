...
class PermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Permission::create(['name' => 'view company', 'guard_name'=>'api']);
        ...
        Permission::create(['name' => 'create freelancer', 'guard_name'=>'api']);
        Permission::create(['name' => 'view freelancer', 'guard_name'=>'api']);
        Permission::create(['name' => 'update freelancer', 'guard_name'=>'api']);
        Permission::create(['name' => 'delete freelancer', 'guard_name'=>'api']);

        // Department permissions
        Permission::create(['name' => 'create department', 'guard_name'=>'api']);
        Permission::create(['name' => 'view department', 'guard_name'=>'api']);
        Permission::create(['name' => 'update department', 'guard_name'=>'api']);
        Permission::create(['name' => 'delete department', 'guard_name'=>'api']);

        // Employee permissions
        Permission::create(['name' => 'create employee', 'guard_name'=>'api']);
        Permission::create(['name' => 'view employee', 'guard_name'=>'api']);
        ...
        Permission::create(['name' => 'view task', 'guard_name'=>'api']);
        Permission::create(['name' => 'update task', 'guard_name'=>'api']);
        ...
        Permission::create(['name' => 'view project', 'guard_name'=>'api']);
        Permission::create(['name' => 'update project', 'guard_name'=>'api']);
        Permission::create(['name' => 'delete project', 'guard_name'=>'api']);
        Permission::create(['name' => 'assign project', 'guard_name'=>'api']);
